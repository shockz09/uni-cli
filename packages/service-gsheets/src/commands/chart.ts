...
const CHART_TYPES = ['bar', 'line', 'pie', 'column'] as const;
...
export const chartCommand: Command = {
  ...
  options: [
    ...
    { name: 'type', short: 't', type: 'string', description: 'Chart type: bar, line, pie, column (default: column)' },
  ...
  async handler(ctx: CommandContext): Promise<void> {
    ...
    const chartTypeMap: Record<ChartType, 'BAR' | 'LINE' | 'PIE' | 'COLUMN'> = {
      bar: 'BAR',
      line: 'LINE',
      pie: 'PIE',
      column: 'COLUMN',
